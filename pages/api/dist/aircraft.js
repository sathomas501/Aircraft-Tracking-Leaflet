...
function handler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var manufacturer, model, page, pageSize, offset, dbPath, db, baseQuery, baseQuery_1, countQuery_1, params_1, queryParams_1, results, totalCount, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    db = new sqlite3_1["default"].Database(dbPath, sqlite3_1["default"].OPEN_READONLY);
                    baseQuery_1 = "\n      SELECT * FROM aircraft a\n      WHERE a.manufacturer = ?\n    ";
                    countQuery_1 = 'SELECT COUNT(*) as total FROM aircraft a WHERE a.manufacturer = ?';
