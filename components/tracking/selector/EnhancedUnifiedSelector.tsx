...
interface ManufacturerSelectionProps {
  manufacturers: SelectOption[];
  isManufacturerMenuOpen: boolean;
  setIsManufacturerMenuOpen: (open: boolean) => void;
  dropdownButtonRef: React.RefObject<HTMLButtonElement>;
  manufacturerMenuRef: React.RefObject<HTMLDivElement>;
  searchTerm: string;
  setSearchTerm: (term: string) => void;
  searchInputRef: React.RefObject<HTMLInputElement>;
  selectManufacturerAndClose: (value: string) => void;
  filteredManufacturers: SelectOption[];
  selectedManufacturer: string | null;
...
interface ModelSelectionProps {
  ...
  isLoading: boolean;
  modelsByPopularity: AircraftModel[];
  fullRefresh: () => void;
}
...
// Manufacturer selection sub-component
const ManufacturerSelection: React.FC<ManufacturerSelectionProps> = ({
  manufacturers,
  isManufacturerMenuOpen,
  setIsManufacturerMenuOpen,
  dropdownButtonRef,
  manufacturerMenuRef,
  searchTerm,
  setSearchTerm,
        ...
        <div className="relative" ref={manufacturerMenuRef}>
          ...
          {!selectedManufacturer && !isManufacturerMenuOpen && (
            <div className="mt-1 text-xs text-gray-500 flex items-center">
              ...
              Click to see all {manufacturers.length} available manufacturers
            </div>
          )}
            ...
            <div
              ...
              style={{
                ...
                top: dropdownButtonRef.current
                  ? dropdownButtonRef.current.getBoundingClientRect().bottom + 5
                  : 'auto',
...
const ModelSelection: React.FC<ModelSelectionProps> = ({
  ...
  return (
    <div className="p-4">
      {/* Action bar with clear/change controls */}
      <div className="mb-3">
        ...
        <div className="transition-all duration-300">
          {!selectedManufacturer ? (
            ...
            <ManufacturerSelection
              ...
              isManufacturerMenuOpen={isManufacturerMenuOpen}
              setIsManufacturerMenuOpen={setIsManufacturerMenuOpen}
              dropdownButtonRef={dropdownButtonRef}
              manufacturerMenuRef={manufacturerMenuRef}
            ...
            <ModelSelection
              ...
              isLoading={isLoading}
              modelsByPopularity={modelsByPopularity}
