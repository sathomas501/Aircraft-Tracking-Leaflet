...
export class CleanupService {
  ...
  dbManager = TrackingDatabaseManager.getInstance();
  ...
  public async initialize(): Promise<void> {
    ...
    try {
      await this.dbManager.initialize(); // Ensure database is initialized
  ...
  public async shutdown(): Promise<void> {
    ...
    const db = TrackingDatabaseManager.getInstance(); // ✅ Correct usage for static method
